...
class stemLAS(object):
    ...
    def lasinfo(self, inp):
        ...
        self.classes.extend(list(range(int(mini_clas.find('id').text),
    ...
    def pdalinfo(self, inp):
        ...
        for sta in out['stats'][0]['statistic']:
            if sta['name'] == 'Classification':
                self.classes.extend(list(range(int(sta['minimum']),
                                          int(sta['maximum']))))
            if sta['name'] == 'NumberOfReturns':
                self.returns.extend(list(range(int(sta['minimum']),
                                          int(sta['maximum']))))
