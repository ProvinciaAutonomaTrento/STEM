...
class STEMToolsDialog(BaseDialog):
    def __init__(self, iface, name):
        ...
        self._insertSecondFileOutput(label = "Goodness of fit", posnum = 10, filt= "TIF files (*.tif)")
...
#            local = self.LocalCheck.isChecked()
            ...
            if cut:
                name = cut
                source = cutsource
            tempin, tempout, gs = temporaryFilesGRASS(name, True) #local)
