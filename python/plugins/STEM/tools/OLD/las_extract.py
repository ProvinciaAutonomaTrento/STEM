...
#               bbox = self.rect_str
            ...
            ###################### R script here ##############################
            processing.run("r:Rasterizzazione_file_Las", { 'File_LAS_di_input' : source, 'Seleziona_il_ritorno_desiderato' : ritorno, 'Seleziona_il_metodo_statistico_da_utilizzare' : metodostat,
            'Risoluzione_finale_del_raster' : ris, 'Percentile_valori_supportati_1_100' : percentile, 'Classe_o_classi_separate_da_uno_spazio_su_cui_filtrare_il_file_Las' :  classfiltlas, 'Soglia_trim' : sogliatrim,
            'Definisci_valori_NA' : nodata, 'Definisci_EPSG' : EPSG, 'Risultato' : output})
            ###################################################################
