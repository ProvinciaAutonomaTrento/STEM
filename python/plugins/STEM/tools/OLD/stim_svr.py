...
#                                                col=invectcol)
        ...
        try:
            ...
            ###################### R script here ##############################
            processing.run("r:Support_Vector_Regression", { 'Dati_di_input_vettoriale_di_training' : vetditraining, 'Seleziona_la_colonna_del_parametro_da_stimare' : colparamdastimare, 
            'Vettoriale_di_mappa' : vetdimappa, 'Inserire_numero_di_fold_della_cross_validation' : nrfoldcrossvalid, 'Seleziona_il_kernel_da_utilizzare' : kerneldautilizzare,
            'Inserire_il_parametro_C' : parametroC, 'Inserire_il_valore_di_epsilon' : valoreepsilon, 'Inserire_il_valore_di_gamma' : valoregamma, 'Inserire_il_valore_del_polinomio' : valpolinomio,
            'Selezionare_la_trasformazione' : trasformazione, 'Seleziona_variabili' : selezionavariabili, 'Colonne_delle_feature_da_utilizzare' : colonnedautilizzare, 
            'File_di_selezione' : filediselezione, 'Vettoriale_di_validazione' : vetdivalidazione, 'Seleziona_colonna_per_la_validazione' : colonnavalidazione, 
            'Risultato' : out, 'Nome_colonna_per_i_valori_della_stima' : nomecolonnavaloristima, 'Accuratezza' : accuratezza})
            ###################################################################
