# -*- coding: utf-8 -*-
#
# STEM develpoment documentation documentation build configuration file, created by
...
stemroot = os.path.split(thispath)[0]

sys.path.insert(0, stemroot)
sys.path.insert(1, os.path.join(stemroot, 'libs'))
sys.path.insert(2, os.path.join(stemroot, 'tools'))
...
htmlhelp_basename = 'STEMdevelpomentdocumentationdoc'
